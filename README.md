This a simple console application which allows you to encode and decode your text message from the standart input or from the file. It uses two algorithms. The first one 
